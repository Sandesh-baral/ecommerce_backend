                ...
                <form action="{{ route('category.update', ['id' => $category->id]) }}" method="post">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="name" name="name"
                            class="w-full p-2 rounded border border-gray-300" placeholder="Category Name here..."
                            value="{{ $category->name }}">
                        @error('name')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="description" name="description"
                            class="w-full p-2 rounded border border-gray-300" placeholder="Description here..."
